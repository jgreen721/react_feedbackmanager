...
import {ReplyBtn,AddReply} from "../"
import "./ReplyCard.css"
// import { useAppContext } from '../../../context/AppContext'
// import "./CommentCard.css"

const ReplyCard = ({id,comment,isReply}) => {
...
// console.log("ID",id,comment);
  ...
  return (
    <div className={isReply ? "comment-card pl-4 b-left reply-card-translate" : "comment-card b-bottom"}>
